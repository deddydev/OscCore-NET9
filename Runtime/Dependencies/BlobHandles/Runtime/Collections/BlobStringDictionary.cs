...
namespace BlobHandles
{
    ...
    public sealed unsafe class BlobStringDictionary<T>(int initialCapacity = BlobStringDictionary<T>.defaultSize) : IDisposable
    {
        const int defaultSize = 16;
        
        public readonly Dictionary<BlobHandle, T> HandleToValue = new(initialCapacity);
        private readonly Dictionary<string, BlobString> SourceToBlob = new(initialCapacity);
